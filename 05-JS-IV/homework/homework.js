...
function verificarPassword (usuario, password) {
  ...
  // fue mi primera logica, y funciono a la primera
  /*for (const key in usuario) {
    if (password === usuario.password) {
      return true;
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  var descuentoTotal = producto.precio - descuento;

  producto.calcularPrecioDescuento = function metodoDescuento(params) {
